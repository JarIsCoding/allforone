...
import { EightBallApi } from '../services/DataServices';
...
export default function MagicComponent() {
    ...
    const getResult = async () => {
        const response = await EightBallApi(numone);
        console.log(numone)
    ...
    return (
        <Container fluid className="px-0 pt-5 position-absolute hellocolor28">
            <Row className='g-0'>
                <Col className='col-12 pt-5 lightbg vh-100'>
                    ...
                    <Col className='col-12 ps-5 pt-3'>
                        ...
                        }} className='hellocolor8 border border-black border-top-0 border-4 rounded-3 buttonsize tf'>
                            Start
                        </button>
                    </Col>
