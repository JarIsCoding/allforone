...
export default function OddOrEvenComponent() {
    ...
    const getResult = async () => {
        const response = await OddEvenApi(numone);
        console.log(numone)
    ...
    return (
        <Container fluid className="px-0 pt-5 position-absolute hellocolor25">
            <Row className='g-0'>
                <Col className='col-12 pt-5 lightbg vh-100'>
                    ...
                    <Row>
                        <Col className='col-4 pt-2 pe-0'>
                            <input type='number' id='UserInput' onChange={(e) => setnumone(e.target.value)} className='ms-5 border-4  input1 border border-black tf input1' placeholder='Enter a Number' />
                        </Col>
                    ...
                    <Col className='col-12 ps-5 pt-3'>
                        ...
                        }} className='hellocolor5 border border-black border-top-0 rounded-3 buttonsize tf'>
                            Start
                        </button>
                    </Col>
